...
type VotingParams struct {
	...
	VotingPeriodParamsChange time.Duration `protobuf:"bytes,1,opt,name=voting_period_params_change,json=votingPeriodParamsChange,proto3,stdduration" json:"voting_period_params_change,omitempty" yaml:"voting_period_params_change"`
	VotingPeriodUpgrade      time.Duration `protobuf:"bytes,2,opt,name=voting_period_upgrade,json=votingPeriodUpgrade,proto3,stdduration" json:"voting_period_upgrade,omitempty" yaml:"voting_period_upgrade"`
	VotingPeriodText         time.Duration `protobuf:"bytes,3,opt,name=voting_period_text,json=votingPeriodText,proto3,stdduration" json:"voting_period_text,omitempty" yaml:"voting_period_text"`
}
...
var fileDescriptor_ad71a474b39c2291 = []byte{
	...
	,
}
...
func (m *VotingParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n8, err8 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.VotingPeriodText, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.VotingPeriodText):])
	if err8 != nil {
		return 0, err8
	}
	i -= n8
	...
	i--
	dAtA[i] = 0x1a
	n9, err9 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.VotingPeriodUpgrade, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.VotingPeriodUpgrade):])
	if err9 != nil {
		return 0, err9
	}
	i -= n9
	...
	i--
	dAtA[i] = 0x12
	n10, err10 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.VotingPeriodParamsChange, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.VotingPeriodParamsChange):])
	if err10 != nil {
		return 0, err10
	}
	i -= n10
...
func (m *VotingParams) Size() (n int) {
	...
	var l int
	_ = l
	l = github_com_gogo_protobuf_types.SizeOfStdDuration(m.VotingPeriodParamsChange)
	n += 1 + l + sovGov(uint64(l))
	l = github_com_gogo_protobuf_types.SizeOfStdDuration(m.VotingPeriodUpgrade)
	n += 1 + l + sovGov(uint64(l))
	l = github_com_gogo_protobuf_types.SizeOfStdDuration(m.VotingPeriodText)
	n += 1 + l + sovGov(uint64(l))
	return n
}
...
func (m *VotingParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VotingPeriodParamsChange", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := github_com_gogo_protobuf_types.StdDurationUnmarshal(&m.VotingPeriodParamsChange, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VotingPeriodUpgrade", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := github_com_gogo_protobuf_types.StdDurationUnmarshal(&m.VotingPeriodUpgrade, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			...
			if err := github_com_gogo_protobuf_types.StdDurationUnmarshal(&m.VotingPeriodText, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
