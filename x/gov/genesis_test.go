...
func TestImportExportQueues(t *testing.T) {
	...
	genesisState := govgenapp.NewDefaultGenesisState()
	...
	db := dbm.NewMemDB()
	app2 := govgenapp.NewGovGenApp(log.NewNopLogger(), db, nil, true, map[int64]bool{}, govgenapp.DefaultNodeHome, 0, govgenapp.MakeTestEncodingConfig(), govgenapp.EmptyAppOptions{})

	app2.InitChain(
		abci.RequestInitChain{
			Validators:      []abci.ValidatorUpdate{},
			ConsensusParams: govgenhelpers.DefaultConsensusParams,
