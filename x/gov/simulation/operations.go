...
func WeightedOperations(
	...
	appParams.GetOrGenerate(cdc, OpWeightMsgVote, &weightMsgVote, nil,
		func(_ *rand.Rand) {
			weightMsgVote = appparams.DefaultWeightMsgVote
		},
	)

	appParams.GetOrGenerate(cdc, OpWeightMsgVoteWeighted, &weightMsgVoteWeighted, nil,
		func(_ *rand.Rand) {
			weightMsgVoteWeighted = appparams.DefaultWeightMsgVoteWeighted
		},
	)
...
func SimulateMsgSubmitProposal(
	...
	return func(
		...
		votingPeriod := k.GetVotingPeriod(ctx, content)
...
func operationSimulateMsgVote(ak types.AccountKeeper, bk types.BankKeeper,
...
func operationSimulateMsgVoteWeighted(ak types.AccountKeeper, bk types.BankKeeper,
	k keeper.Keeper, simAccount simtypes.Account, proposalIDInt int64,
) simtypes.Operation {
	return func(
		r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context,
